...
<img src="images/weapon-watch-icon.png" alt="icon" width="150" height="150">
...
- System Diagram
    - Stage 1
    - ![system-diagram](images/bomb-watch-v1.jpg "system-diagram")

    - Stage 2
    - ![system-diagram](images/weapon-wtach-v2.jpg "system-diagram")
